...
<div class="py-4 max-w-2xl">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <h2 class="text-base font-semibold text-gray-800 mb-5">Add Teacher</h2>
        ...
        <form method="POST" action="{{ route('teachers.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Md. Karim"
                ...
                <div>
                    ...
                    <input type="text" name="username" value="{{ old('username') }}" required placeholder="e.g. karim.math"
                    ...
                    <p class="text-xs text-gray-500 mt-1">Letters, numbers, dashes & underscores only. This is the login ID.</p>
