        ...
        <form method="POST" action="{{ route('subjects.store') }}" x-data="subjectForm()" class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" placeholder="e.g. MAT"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                <div>
                ...
                <div class="col-span-2">
                    <label class="flex items-center gap-2 text-sm font-medium text-gray-700 cursor-pointer">
                        <input type="checkbox" name="is_optional" value="1" {{ old('is_optional') ? 'checked' : '' }} class="rounded">
                        Optional Subject
                    </label>
                </div>
            </div>
...
function subjectForm() {
    return {
        hasSubSubjects: {{ old('has_sub_subjects') ? 'true' : 'false' }},
