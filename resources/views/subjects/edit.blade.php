            ...
            <div class="mb-4 space-y-3">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
                    <div>
                        ...
                        <input type="number" name="full_marks" value="{{ old('full_marks', $subject->full_marks) }}" required min="1" step="0.01"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Subject Pass Marks *</label>
                        <input type="number" name="pass_marks" value="{{ old('pass_marks', $subject->pass_marks) }}" required min="0" step="0.01"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                    </div>
                    <div class="col-span-1 sm:col-span-2 mt-2">
                        <label class="flex items-center gap-2 text-sm font-medium text-gray-700 cursor-pointer">
                            <input type="checkbox" name="is_individual_pass" value="1" {{ old('is_individual_pass', $subject->is_individual_pass) ? 'checked' : '' }} class="rounded text-blue-600 focus:ring-blue-500">
                            <div>
