...
<div class="py-4 max-w-md">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <h2 class="text-base font-semibold text-gray-800 mb-5">Edit Class: {{ $class->name }}</h2>
        <form method="POST" action="{{ route('classes.update', $class) }}" class="space-y-4">
            @csrf @method('PUT')
            <div>
            ...
            <div>
                ...
                <input type="number" name="sort_order" value="{{ old('sort_order', $class->sort_order) }}" min="0"
