...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'MarksCraft'); ?> – Dynamic Result Management</title>
...
<div class="flex h-full">
    ...
    <div x-show="sidebarOpen" x-cloak class="fixed inset-0 z-40 lg:hidden">
        ...
        <div x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-200 transform"
            ...
            <?php echo $__env->make('layouts._nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            
            <?php echo $__env->make('layouts._user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 flex items-center justify-between print:hidden">
            ...
            <div class="flex items-center gap-4 text-sm text-gray-500">
                <span class="hidden sm:inline"><?php echo e(now()->format('d M Y')); ?></span>
                <?php
                    $activeExam = cache()->remember('active_exam_' . auth()->id(), 300, function () {
                        return \App\Models\Exam::active()->latest()->first();
                    });
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeExam): ?>
                    <span class="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">
                        Active: <?php echo e($activeExam->name); ?> <?php echo e($activeExam->year); ?>
                ...
                <nav class="flex text-xs text-gray-500 mb-4 print:hidden" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center hover:text-blue-600 transition-colors">
                                🏠 Home
                            </a>
                        </li>
                        <?php
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="<?php echo e(url($url)); ?>" class="capitalize hover:text-blue-600 transition-colors"><?php echo e(str_replace('-', ' ', $segment)); ?></a>
                                </div>
                            </li>
...
<?php /**PATH /home/tahmids55/Deployment/markscraft/resources/views/layouts/app.blade.php ENDPATH**/ ?>