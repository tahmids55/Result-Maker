...
<div class="py-4 space-y-4">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        <form method="GET" action="<?php echo e(route('classes.index')); ?>" class="flex flex-wrap md:flex-nowrap gap-3">
            <div class="flex-1">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('classes.index')); ?>" class="border border-gray-300 text-gray-600 hover:bg-gray-50 text-sm px-3 py-2 rounded-lg transition-colors flex items-center">
                    ✕
                </a>
            </div>
        </form>
    ...
    <div class="flex justify-between items-center">
        <p class="text-sm text-gray-500"><?php echo e($classes->total()); ?> classes found</p>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($classes->isEmpty()): ?>
            <div class="py-16 text-center text-gray-400">
                <p class="text-4xl mb-3">🏫</p>
                <p class="text-sm">No classes yet. <a href="<?php echo e(route('classes.create')); ?>" class="text-blue-600 hover:underline">Add one →</a></p>
            </div>
        <?php else: ?>
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 font-semibold text-gray-900"><?php echo e($class->name); ?></td>
                        <td class="px-4 py-3 text-center text-gray-600"><?php echo e($class->sections_count); ?></td>
                        <td class="px-4 py-3 text-center text-gray-600"><?php echo e($class->students_count); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tahmids55/Deployment/markscraft/resources/views/classes/index.blade.php ENDPATH**/ ?>