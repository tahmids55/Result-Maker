...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
            Already have an account? <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:underline font-medium">Sign in</a>
        </p>
    </div>
</div>
</body>
</html>
<?php /**PATH /home/tahmids55/Deployment/markscraft/resources/views/auth/register.blade.php ENDPATH**/ ?>