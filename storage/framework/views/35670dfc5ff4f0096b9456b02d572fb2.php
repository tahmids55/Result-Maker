...
<div class="py-4 space-y-4" x-data="{ 
    selectedIds: [], 
    selectAll: false, 
    toggleAll() { this.selectedIds = this.selectAll ? <?php echo e(json_encode($students->pluck('id')->toArray())); ?> : [] },
    showModal: false,
    viewStudent: null,
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        <form method="GET" action="<?php echo e(route('students.index')); ?>" class="flex flex-col gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('students.index')); ?>" title="Clear Filters" class="border border-gray-300 text-gray-600 hover:bg-gray-50 text-sm px-4 py-2 rounded-lg transition-colors flex items-center justify-center">
                    ✕
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <select name="per_page" onchange="this.form.submit()"
                        class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none">
                    <option value="30" <?php echo e(request('per_page', 30) == 30 ? 'selected' : ''); ?>>30 per page</option>
                    <option value="50" <?php echo e(request('per_page') == 50 ? 'selected' : ''); ?>>50 per page</option>
                    <option value="70" <?php echo e(request('per_page') == 70 ? 'selected' : ''); ?>>70 per page</option>
    ...
    <div class="flex flex-wrap gap-3 items-center justify-between">
        <p class="text-sm text-gray-500"><?php echo e($students->total()); ?> students found</p>
        <div class="flex gap-2">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" x-cloak @click.away="open=false"
                    ...
                    <form method="POST" action="<?php echo e(route('students.bulk-import')); ?>" enctype="multipart/form-data" class="space-y-2">
                        <?php echo csrf_field(); ?>
            ...
            <form method="POST" action="<?php echo e(route('students.bulk-delete')); ?>" 
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($students->isEmpty()): ?>
            <div class="py-16 text-center text-gray-400">
                ...
                <p class="text-sm">No students found. <a href="<?php echo e(route('students.create')); ?>" class="text-blue-600 hover:underline">Add one →</a></p>
            </div>
        <?php else: ?>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <input type="checkbox" value="<?php echo e($student->id); ?>" x-model="selectedIds" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                            </td>
                            <td class="px-4 py-3 font-mono text-gray-700 font-medium"><?php echo e($student->roll); ?></td>
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="font-medium text-gray-900"><?php echo e($student->name); ?></span>
                                </div>
                            </td>
                            ...
                            <td class="px-4 py-3 text-gray-500"><?php echo e($student->father_name ?? '–'); ?></td>
                            <td class="px-4 py-3 text-gray-500"><?php echo e($student->session ?? '–'); ?></td>
                            <td class="px-4 py-3 text-gray-500 font-mono text-xs"><?php echo e($student->registration_no ?? '–'); ?></td>
                            <td class="px-4 py-3 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <button type="button" @click='openViewModal(<?php echo e(json_encode([
                                        "name" => $student->name,
                                        "roll" => $student->roll,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tahmids55/Deployment/markscraft/resources/views/students/index.blade.php ENDPATH**/ ?>