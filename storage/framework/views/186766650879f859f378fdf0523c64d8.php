<?php $__env->startSection('title', 'Marksheet Templates'); ?>
...
<div class="py-4 space-y-4" x-data="{ editModalOpen: false, editForm: { id: '', name: '', description: '', url: '' }, openEditModal(template, editUrl) { this.editForm.id = template.id; this.editForm.name = template.name; this.editForm.description = template.description || ''; this.editForm.url = editUrl; this.editModalOpen = true; } }">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($templates->isEmpty()): ?>
        <div class="bg-white rounded-xl border border-dashed border-gray-300 p-12 text-center">
            ...
            <a href="<?php echo e(route('templates.create')); ?>" class="text-blue-600 font-medium hover:underline">Upload Template →</a>
        </div>
    <?php else: ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-xl border <?php echo e($template->is_default ? 'border-blue-400 ring-2 ring-blue-200' : 'border-gray-200'); ?> shadow-sm p-5">
                <div class="flex items-start justify-between mb-3">
                    <div>
                        <div class="font-semibold text-gray-900 flex items-center gap-2">
                            <?php echo e($template->name); ?>

                            <button type="button" @click='openEditModal(<?php echo json_encode(["id" => $template->id, "name" => $template->name, "description" => $template->description]) ?>, "<?php echo e(route("templates.update", $template)); ?>")' class="text-gray-400 hover:text-blue-600 focus:outline-none">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->description): ?>
                    <p class="text-xs text-gray-500 mb-3"><?php echo e($template->description); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <div class="mb-3">
                    <p class="text-xs font-medium text-gray-600 mb-1">Detected Placeholders (<?php echo e(count($template->placeholders ?? [])); ?>)</p>
                    <div class="flex flex-wrap gap-1">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = array_slice($template->placeholders ?? [], 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <code class="text-xs bg-gray-100 text-gray-700 px-1.5 py-0.5 rounded"><?php echo e('${' . $ph . '}'); ?></code>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($template->placeholders ?? []) > 6): ?>
                            <span class="text-xs text-gray-400">+<?php echo e(count($template->placeholders) - 6); ?> more</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>

                <div class="flex gap-2 pt-3 border-t border-gray-100">
                    <a href="<?php echo e(route('templates.map', $template)); ?>"
                    ...
                    <a href="<?php echo e(route('onlyoffice.edit', $template->id)); ?>"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$template->is_default): ?>
                    <form method="POST" action="<?php echo e(route('templates.set-default', $template)); ?>" class="flex-1">
                        <?php echo csrf_field(); ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <form method="POST" action="<?php echo e(route('templates.destroy', $template)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tahmids55/Deployment/markscraft/resources/views/templates/index.blade.php ENDPATH**/ ?>