...
<div class="py-4 space-y-4">
    ...
    <div class="flex flex-wrap gap-3 items-center justify-between">
        <form method="GET" action="<?php echo e(route('subjects.index')); ?>" class="flex flex-wrap gap-3 w-full md:w-auto flex-1 mr-4">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subjects->isEmpty()): ?>
            <div class="py-16 text-center text-gray-400">
                ...
                <p class="text-sm">No subjects yet. <a href="<?php echo e(route('subjects.create')); ?>" class="text-blue-600 hover:underline">Add one →</a></p>
            </div>
        <?php else: ?>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->code): ?><div class="text-xs text-gray-400"><?php echo e($subject->code); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->is_optional): ?><span class="text-xs bg-purple-100 text-purple-600 px-1.5 py-0.5 rounded">Optional</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-4 py-3 text-gray-600"><?php echo e($subject->schoolClass->name); ?> / <?php echo e($subject->section->name); ?></td>
                        <td class="px-4 py-3">
                            <div class="flex flex-wrap gap-1">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subject->has_sub_subjects): ?>
                                    <span class="text-xs bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded-full font-medium">
                                        <?php echo e($subject->subSubjects->count()); ?> Papers
                                    </span>
                                <?php else: ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subject->exam_components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $compName => $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="text-xs bg-blue-50 text-blue-700 px-2 py-0.5 rounded-full">
                                            <?php echo e(strtoupper($compName)); ?>: <?php echo e($config['full']); ?>
                        ...
                        <td class="px-4 py-3 font-semibold text-gray-800">
                            <?php echo e($subject->total_full_marks); ?>

                            <span class="text-xs text-gray-400 font-normal">(pass: <?php echo e($subject->total_pass_marks); ?>)</span>
                        </td>
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <form method="POST" action="<?php echo e(route('subjects.copy', $subject)); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tahmids55/Deployment/markscraft/resources/views/subjects/index.blade.php ENDPATH**/ ?>